...
@SpringBootTest
@DirtiesContext
public class ProducerKafkaApplicationTest {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ProducerKafkaApplicationTest.class);
    private static String SENDER_TOPIC = "java_topic";
    ...
    @Test
    public void contLoads() throws InterruptedException  {

        // send the message
        String greeting = "Hello Spring Kafka Sender!";
       kafkaSender.send(greeting);
